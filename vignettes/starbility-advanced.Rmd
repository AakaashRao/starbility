...
2. Using functions to estimate coefficients that are not automatically supported in \code{starbility}. (Currently, the only function automatically supported is `felm`.)
...
```{r glm1, fig.width = 7.2, fig.height = 4}
...
```{r glm2, fig.width = 7.2, fig.height = 4}
...
```{r glm3, fig.width = 7.2, fig.height = 4}
library(margins)
...
```{r manualplot, fig.width = 7.2, fig.height = 4}
